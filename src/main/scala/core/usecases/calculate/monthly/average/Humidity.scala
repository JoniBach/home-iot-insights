...
/**
 * Use case for calculating monthly average humidity.
 * This is designed to be run monthly (e.g., at 1 AM) to process the previous month's data.
 */
final class CalculateMonthlyAverageHumidity[F[_]: Monad](
...
object CalculateMonthlyAverageHumidity {
  /**
  ...
  def default[F[_]: Monad](
  ...
  ): CalculateMonthlyAverageHumidity[F] = {
    ...
    new CalculateMonthlyAverageHumidity[F](
